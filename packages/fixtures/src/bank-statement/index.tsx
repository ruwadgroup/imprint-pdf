...
function Amount({ value, credit }: { value: number | null; credit?: boolean }) {
  if (value == null || value === 0) {
    return <span className="text-right font-mono text-[9.5px] text-slate-400">–</span>;
  }
  return (
    <span
      className={`text-right font-mono text-[9.5px] font-medium ${
      ...
      <Page size="A4" className="bg-white px-14 pb-12 pt-8 font-sans text-slate-900">
        ...
        <Header>
          <div className="mb-5 flex flex-row items-center justify-between border-b border-slate-200 pb-2">
            <span className="text-[8px] font-semibold uppercase tracking-[1.2pt] text-slate-400">
              {data.bank}
            </span>
            <span className="font-mono text-[8px] uppercase tracking-[1.2pt] text-slate-400">
        ...
        <Footer>
          <div className="mt-6 flex flex-row items-center justify-between border-t border-slate-200 pt-3">
            <span className="font-mono text-[8px] text-slate-400">{data.accountNumberMasked}</span>
        ...
        <div className="-mx-14 flex flex-row items-start justify-between bg-teal-700 px-14 pb-7 pt-7">
          <div className="flex flex-col">
            ...
            <h1 className="text-[30px] font-bold leading-none tracking-[-1pt] text-white">
              Statement<span className="font-light"> of Account</span>
            </h1>
          </div>
          <div className="flex flex-col items-end gap-2 pt-1">
            <span className="text-[7.5px] font-semibold uppercase tracking-[1.5pt] text-teal-100">
              Statement period
            </span>
            <span className="font-mono text-[12px] font-semibold text-white">{data.period}</span>
          </div>
        </div>
        ...
        <div className="mb-7 mt-7 flex flex-row items-start justify-between">
          <div className="flex flex-col">
            ...
            <p className="mt-1.5 text-[17px] font-bold tracking-[-0.3pt] text-slate-900">
              {data.accountHolder}
            </p>
          </div>
        ...
        <div className="mb-8 flex flex-row gap-3">
          <div className="flex flex-1 flex-col rounded-md border border-slate-200 px-3.5 py-3">
            <span className="text-[7.5px] font-semibold uppercase tracking-[1.2pt] text-slate-400">
              Opening balance
            </span>
            <div className="mt-2 flex flex-row items-baseline gap-0.5">
              <span className="font-mono text-[16px] font-bold tracking-[-0.3pt] text-slate-900">
          ...
          <div className="flex flex-1 flex-col rounded-md border border-slate-200 px-3.5 py-3">
            ...
            <div className="mt-2 flex flex-row items-baseline gap-0.5">
              <span className="font-mono text-[12px] font-bold text-green-700">+</span>
              <span className="font-mono text-[16px] font-bold tracking-[-0.3pt] text-slate-900">
                {money(totalCredits)}
              </span>
            </div>
          ...
          <div className="flex flex-1 flex-col rounded-md border border-slate-200 px-3.5 py-3">
            ...
            <div className="mt-2 flex flex-row items-baseline gap-0.5">
              <span className="font-mono text-[12px] font-bold text-slate-600">-</span>
              <span className="font-mono text-[16px] font-bold tracking-[-0.3pt] text-slate-900">
                {money(totalDebits)}
              </span>
            </div>
          ...
          <div className="flex flex-1 flex-col rounded-md bg-teal-700 px-3.5 py-3">
            <span className="text-[7.5px] font-semibold uppercase tracking-[1.2pt] text-teal-100">
              Closing balance
            </span>
            <div className="mt-2 flex flex-row items-baseline gap-0.5">
              <span className="font-mono text-[16px] font-bold tracking-[-0.3pt] text-white">
        ...
        <Table>
          ...
          {rows.map((t, i) => (
            ...
            >
              <Td width={50} className="font-mono text-[9.5px] text-slate-500">
                {t.date}
              </Td>
              <Td flex className="text-[10px] font-medium text-slate-900">
                {t.description}
              </Td>
              ...
              <Td align="right" width={92}>
                <span className="text-right font-mono text-[9.5px] font-semibold text-slate-900">
                  {money(t.balance)}
                </span>
              </Td>
            </Tr>
          ...
          <Tr className="rounded-b bg-teal-100 px-4">
            ...
            <Td flex>
              <span className="text-[8px] font-bold uppercase tracking-[1.2pt] text-teal-900">
                Closing balance
              </span>
            </Td>
            <Td align="right" width={78}>
              <span className="text-right font-mono text-[9.5px] font-semibold text-slate-600">
                {money(totalDebits)}
              </span>
            </Td>
            <Td align="right" width={78}>
              <span className="text-right font-mono text-[9.5px] font-semibold text-green-700">
                {money(totalCredits)}
              </span>
            </Td>
            <Td align="right" width={92}>
              <span className="text-right font-mono text-[11px] font-bold text-teal-900">
                {money(closingBalance)}
              </span>
            </Td>
          </Tr>
        ...
        <p className="mt-5 text-[8px] leading-relaxed text-slate-400">
